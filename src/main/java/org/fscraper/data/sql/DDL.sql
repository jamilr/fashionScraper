...
INSERT INTO StoreCategory(store_id, category_id, gender, url, quantity)  VALUES(5, 1, 1, "http://www.marksandspencer.com/l/men/all-shoes-and-boots",        20);
INSERT INTO StoreCategory(store_id, category_id, gender, url, quantity)  VALUES(5, 4, 1, "http://www.marksandspencer.com/l/men/casual-shirts",              20);
INSERT INTO StoreCategory(store_id, category_id, gender, url, quantity)  VALUES(5, 5, 1, "http://www.marksandspencer.com/l/men/formal-trousers",            20);
INSERT INTO StoreCategory(store_id, category_id, gender, url, quantity)  VALUES(5, 6, 1, "http://www.marksandspencer.com/l/men/coats-and-casual-jackets",   20);

/*Burberry Female*/
INSERT INTO StoreCategory(store_id, category_id, gender, url, quantity)  VALUES(6, 1, 0, "http://uk.burberry.com/womens-shoes/",                            20);
INSERT INTO StoreCategory(store_id, category_id, gender, url, quantity)  VALUES(6, 2, 0, "http://uk.burberry.com/womens-bags/",                             20);
INSERT INTO StoreCategory(store_id, category_id, gender, url, quantity)  VALUES(6, 3, 0, "http://uk.burberry.com/dresses/",                                 20);
INSERT INTO StoreCategory(store_id, category_id, gender, url, quantity)  VALUES(6, 4, 0, "http://uk.burberry.com/womens-shirts-tops/",                      20);
INSERT INTO StoreCategory(store_id, category_id, gender, url, quantity)  VALUES(6, 7, 0, "http://uk.burberry.com/womens-ponchos-wraps/",                      20);
INSERT INTO StoreCategory(store_id, category_id, gender, url, quantity)  VALUES(6, 8, 0, "http://uk.burberry.com/womens-knitwear/",                      20);
