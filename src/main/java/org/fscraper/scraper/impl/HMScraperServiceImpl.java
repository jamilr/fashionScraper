...
@Service("HM")
public class HMScraperServiceImpl
        extends AbstractScraperService
        implements ScraperService {

    private static Logger logger = Logger.getLogger(HMScraperServiceImpl.class.getName());

    public static final String DATA_EXTRACTOR = "HMDataExtractor";

    public HMScraperServiceImpl(){

    }

    @Override
    public String getDataExtractorName(){
        return HMScraperServiceImpl.DATA_EXTRACTOR;
    }
